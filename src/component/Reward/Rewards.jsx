    ...
    <section className="py-20 bg-gradient-to-r from-purple-500 to-[#0A1830]">
      <div className="container mx-auto text-center">
        <h2 className="text-5xl font-bold text-white">
          0% APR <sup>Industry Leading Rewards</sup>
        </h2>
        <p className="mt-4 text-2xl text-white">
          Dynamic liquidity providers share platform fees captured in blue-chip
          assets
        </p>
          ...
          <div className="bg-[#49618a]  p-6 rounded shadow-md">
            ...
            <div className="mt-4">
              ...
              <h4 className="text-2xl">
                <CountUp start={100} end={0} duration={100.5} separator="," />%
              </h4>
            </div>
          </div>
          <div className="bg-[#49618a]   p-6 rounded shadow-md">
            ...
            <div className="mt-4">
              <p>USDT</p>
              <h4 className="text-2xl">
                <CountUp start={300} end={0} duration={100.5} separator="," />%
              </h4>
            </div>
          </div>
          <div className="bg-[#49618a]   p-6 rounded shadow-md">
            ...
            <div className="mt-4">
              <p>ETH</p>
              <h4 className="text-2xl">
                <CountUp start={200} end={0} duration={100.5} separator="," />%
              </h4>
            </div>
          </div>
          <div className="bg-[#49618a]   p-6 rounded shadow-md">
